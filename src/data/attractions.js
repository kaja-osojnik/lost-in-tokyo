...
const attractions = [
  ...
  {
    title: 'Shibuya',
    description: 'Hunt for quality tunes at Shibuyas best record shops – this is heaven for vinyl hunters and other discerning musos.',
    link: 'https://www.timeout.com/tokyo/music/best-record-stores-in-shibuya',
    image: 'image_10.jpg',
    className: 'w-third-l ml5-l'
  }
];
